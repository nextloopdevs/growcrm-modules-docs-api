...
Returns the (paginated) invoices generated by the subscription — see [Invoices](invoices.md).
...
See [Getting started](getting-started.md#errors). Subscription-specific:
